...
3. Edit the content in `src/App.jsx`

## What's included

- Single-page React app with sections for featured projects, current focus, and links
- Vite dev/build setup
- A polished responsive layout you can customize quickly
